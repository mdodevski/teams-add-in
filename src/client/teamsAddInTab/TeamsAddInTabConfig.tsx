...
/**
 * Implementation of Teams AddIn Tab configuration page
 */
export const TeamsAddInTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            ...
            suggestedDisplayName: "Teams AddIn Tab",
            removeUrl: host + "/teamsAddInTab/remove.html?theme={theme}",
